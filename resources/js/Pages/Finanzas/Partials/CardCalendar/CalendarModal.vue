...
<template>
    <DialogModal :show="show" @close="close()" :maxWidth="'8xl'">
        <template #title>
            <div
                class="flex mb-8 mt-4 items-center justify-between relative w-[80rem]"
            >
                <div class="flex">
                    <div class="px-4 py-1">
                        <span
                            class="block font-bold text-center text-fuente-500 text-[26px] uppercase"
                        >
                            {{ dataCalendar.serie }}
                        </span>
                    </div>
            ...
            <TableComponent>
                <template #thead>
                    ...
                    >
                        ...
                        <th
                            v-if="dataCalendar.serie == 'ventas'"
                        ...
                        <td class="flex justify-center">
                            <div class="tooltip">
                                ...
                                <svg
                                    ...
                                    style="
                                        enable-background: new 0 0 511.999
                                            511.999;
                                        width: 2rem;
                                    "
                                    xml:space="preserve"
