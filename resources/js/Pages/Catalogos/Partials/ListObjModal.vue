...
<template>
    <DialogModal :show="show" @close="close()">
        ...
        <template #content>
            ...
            <!-- MODALS -->
            <FormModal :route-name="props.routeName" :title="props.title" :show="showingForm" :type-form="typeForm"
                :object="object" @add="emit('add')" @edit="updateObj($event)" @close="showingForm = false" />
            <!-- ENDS MODALS -->
        </template>
    </DialogModal>
</template>
