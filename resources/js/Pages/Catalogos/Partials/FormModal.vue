...
const create = () => {
    axios.post(route(`${props.routeName}.store`), form,
        {
            onUploadProgress: () => {
...
const update = () => {
    axios.put(route(`${props.routeName}.update`, props.object.id), form,
        {
            onUploadProgress: () => {
                form.processing = true;
            },
            ...
            <form @submit.prevent="createOrUpdate()">
                <div class="grid grid-cols-2 gap-2 px-4 py-2 text-sm">
                    <div>
                        ...
                        <Input id="nombre" name="referencia" type="text" v-model="form.nombre" required
                            maxlength="30" />
