...
let chart = null;
watch(() => props.arregloValores,(newData) => //el whatcher observa el cambio de la data proveniente
  { 
...
onMounted(() => 
{
    ...
    xAxis.dataFields.category = "GrupoConName";
    yAxis.dataFields.category = "ClienteName";
    ...
    series.dataFields.categoryX = "GrupoConName";
    series.dataFields.categoryY = "ClienteName";
