            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 h-[6.5rem] grid items-center bg-fuente-500">
                    <div class="flex justify-between h-16">
                        <div class="flex justify-around gap-20">
                            ...
                            <!-- Navigation Links -->
                            <div class="flex border-b-[2px] border-nav-500/60">
...
">
                            ...
                            <!-- Settings Dropdown -->
                            <div class="relative ml-3">
                                <JetDropdown align="right" width="48" class="w-10">
                                    <template #trigger>
                                        <button v-if="
                                            $page.props.jetstream
                ...
                <div :class="{
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <JetResponsiveNavLink :href="route('catalogos.index')" :active="route().current('catalogos.index')">
                            Usuarios
                        </JetResponsiveNavLink>
                        <JetResponsiveNavLink :href="route('catalogos.index')" :active="route().current('catalogos.index')">
                            Catalogos
